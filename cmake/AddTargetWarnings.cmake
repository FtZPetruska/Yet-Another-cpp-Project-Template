...
function(set_available_warnings)
  ...
  if(MSVC)
    check_cxx_compiler_flag("/WX" HAVE_WARNING_AS_ERROR)
  else()
    check_cxx_compiler_flag("-Werror" HAVE_WARNING_AS_ERROR)
  endif()
  if(HAVE_WARNING_AS_ERROR)
    option(MYPROJECT_ENABLE_WARNING_AS_ERROR "Treat compiler warnings as errors" ON)
  endif()

  if(MYPROJECT_ENABLE_WARNING_AS_ERROR)
    if(MSVC)
...
function(set_target_warnings target)
  target_compile_options(${target} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${MYPROJECT_CXX_WARNINGS}>
